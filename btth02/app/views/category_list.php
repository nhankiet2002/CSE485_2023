                ...
                <?php if ($categories->num_rows > 0): ?>
                    <?php while ($row = $categories->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <a href="../admin/edit_category.php?id=<?php echo $row['ma_tloai']; ?>" class="btn btn-warning">Sửa</a>
                                <a href="../admin/delete_category.php?id=<?php echo $row['ma_tloai']; ?>" class="btn btn-danger">Xóa</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                <?php else: ?>
