...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="../admin/edit_article.php?id=<?php echo $row['ma_bviet']; ?>" class="btn btn-warning">Sửa</a>
                <a href="../admin/delete_article.php?id=<?php echo $row['ma_bviet']; ?>" class="btn btn-danger">Xóa</a>
            </td>
        </tr>
        <?php endwhile; ?>
    </tbody>
