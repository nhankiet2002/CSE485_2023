...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="../admin/edit_author.php?ma_tgia=<?php echo $row['ma_tgia']; ?>" class="btn btn-warning">Sửa</a>
                <a href="../admin/delete_author.php?ma_tgia=<?php echo $row['ma_tgia']; ?>" class="btn btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa tác giả này?')">Xóa</a>
            </td>
        </tr>
        <?php endwhile; ?>
    </tbody>
