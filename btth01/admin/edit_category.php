...
if (isset($_GET['ma_tloai'])) {
    ...
    echo "<script>alert('Không có mã thể loại!'); window.location.href='category.php';</script>";
    exit;
}
?>
        ...
        <div class="row">
            <div class="col-sm">
                ...
                <div class="input-group mt-3 mb-3">
                        ...
                        <p class="form-control"><?php echo $row['ma_tloai']; ?></p>
                        <input type="hidden" name="ma_tloai" value="<?php echo $row['ma_tloai']; ?>">                    
                </div>
