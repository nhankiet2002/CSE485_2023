...
<?php
    ...
    $sql = "SELECT b.ma_bviet, b.tieude, b.ten_bhat, b.tomtat, b.noidung, b.ngayviet, b.hinhanh, t.ten_tloai, tg.ten_tgia 
            FROM baiviet b
                    ...
                    <?php
                            if ($result->num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td><img src='" . $row['hinhanh'] . "' alt='Hình bài viết' width='100'></td>";
