                    ...
                    <?php
                            if ($result->num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    // Hiển thị hình ảnh của tác giả (cần lưu ý đường dẫn)
                                    echo "<td><img src='" . $row['hinh_tgia'] . "' alt='Hình tác giả' width='100'></td>";
                                ...
                                echo "<tr><td colspan='5'>Không có tác giả nào.</td></tr>";
                            }
                        ?>
                    </tbody>
                </table>
